commit 3fb50d6f75c47608c8908376ad0768271a4f9e59
Author: Wayne Sun <gsun@redhat.com>
...
diff --git a/docs/env-file-preparation.md b/docs/env-file-preparation.md
new file mode 100644
index 0000000..ee33539
--- /dev/null
+++ b/docs/env-file-preparation.md
@@ -0,0 +1,132 @@
...
+```
+
+`AI_TASK_FILE` takes precedence over `AI_TASK_PROMPT`. See [.gitlab/prompts/README.md](../.gitlab/prompts/README.md) for the DSPy task schema.
+
